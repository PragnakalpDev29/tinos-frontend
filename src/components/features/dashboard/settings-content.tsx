...
export function SettingsContent() {
 ...
 <div>
 <h1 className="text-3xl font-bold text-[#08333D]">Settings</h1>
 <p className="text-[#466F78] mt-2">Manage your account preferences</p>
 </div>
 ...
 required
 className="w-full px-4 py-3 border border-[#466F78]/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
 />
 </div>
 <div>
 <label className="block text-sm font-semibold text-[#08333D] mb-2">
