                                    ...
                                    return (
                                        <div key={index} className="flex items-center justify-between p-3 bg-white rounded-lg border border-slate-200">
                                            ...
                                            <div className="flex gap-1 ml-4 shadow-sm">
                                                ...
                                                {status?.status !== 'completed' && <button type="button" onClick={() => cancelUpload(file.name)} className="p-1 px-2 rounded-md bg-red-100 text-red-700 hover:bg-red-200 transition-colors"><X className="w-3.5 h-3.5" /></button>}
                                            </div>
                                        </div>
                                    )
                                })}
