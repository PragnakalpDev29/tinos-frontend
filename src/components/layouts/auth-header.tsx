      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <Link className="flex items-center gap-2" href="/">
            <div className="w-10 h-10 bg-[#08333D] rounded-lg flex items-center justify-center text-[#08333D]">
              <PlusSquare />
            </div>
          ...
          <div className="flex items-center gap-4">
            {showBackToLogin ? (
              <Link className="text-slate-600 hover:text-blue-600 font-bold" href="/login">
                Back to Login
              </Link>
            ) : (
              <Link className="text-slate-600 hover:text-blue-600 font-bold" href="/login">
